...
def get_validate_by_eee(gt: str, challenge: str) -> GeetestResult:  # pylint: disable=invalid-name
    """获取人机验证结果"""
    try:
        validate = None
...
# def get_validate_by_ttocr(gt: str, challenge: str, websiteUrl: str) -> GeetestResult:  # pylint: disable=invalid-name
#     """获取人机验证结果(ttocr)"""
#     try:
