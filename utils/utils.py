...
from .data_model import TokenResultHandler, GeetestResult
...
def get_token_by_captcha(url: str,use_2captcha: bool) -> str | bool:
    """通过人机验证码获取TOKEN"""
    try:
        print(url)
        ...
        if use_2captcha:
            ...
            geetest_data =  get_validate_by_eee(gt, challenge)
        # validate=input("validate")
        # challenge=input("challenge")
        # geetest_data =GeetestResult(challenge=challenge, validate=validate)
        params = {
